#!/usr/bin/env python3
"""Windows helper to summarise and filter review decisions."""
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Summarise manager decisions from the review CSV (Windows edition).")
        ...
        config = {
            "logging": {
                ...
                "file": {
                    "enabled": True,
                    "level": "DEBUG",
                    "path": str(base_dir / "logs" / "review_helper_windows.log"),
                },
            }
        }
